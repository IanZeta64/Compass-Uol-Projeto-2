...
### Pet Api
- Access the database console at [http://localhost:8081/h2](http://localhost:8081/h2).
- Use the following connection information:
  - JDBC URL: jdbc:h2:mem:./database/petApi;
  - User Name: admin;
  - Password: admin.

### Adoption Api
- Access the database console at [http://localhost:8082/h2](http://localhost:8082/h2).
- Use the following connection information:
  - JDBC URL: jdbc:h2:mem:./database/adoptionApi;
  - User Name: admin;
  - Password: admin.
...
- First run test with coverage individually, then run test with coverage for the whole class.
- All the tests are parameterized with method source receiving methods from a dummy class.
